...
export type EditProfileQuery = { __typename?: 'Query', me: { __typename?: 'User', username: string, firstName: string, bio: Types.Maybe<string>, lastName: Types.Maybe<string>, email: string, avatar: Types.Maybe<string>, coverImage: Types.Maybe<string> } };
