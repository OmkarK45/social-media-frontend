	...
	return (
		<label>
			...
			<div className="flex">
				...
				<input
					className={clsx(
						'w-full transition duration-500 ease-in-out border-2 border-gray-300 dark:border-gray-600 shadow-sm dark:bg-gray-800   focus:border-brand-600 focus:ring-brand-500 disabled:opacity-60 disabled:bg-gray-500 disabled:bg-opacity-20 rounded-md disabled:cursor-not-allowed',
						className,
